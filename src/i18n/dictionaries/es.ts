...
const es = {
  ...
  atlas: {
    ...
    lede: "Cuéntale a Atlas qué buscas, cómo compras y cuánto quieres invertir. Revisa el catálogo completo y te dice por dónde empezar, qué más considerar y por qué.",
    metaDescription:
    ...
    intro: {
      ...
      boundary:
        "Atlas elige con base en tus objetivos, preferencias y presupuesto. No usa información de salud, peso ni medicamentos, y no indica cantidades, formas de uso ni horarios.",
      sources:
    ...
    generating: {
      ...
      stages: [
        ...
        "Comparando precios, presentaciones y documentación",
        "Escribiendo tu selección",
      ],
      note: "Precios, presentaciones y documentación salen del catálogo; Atlas escribe la explicación.",
    },
    error: {
      title: "No pudimos preparar tu selección",
      body: "Algo falló. Tus respuestas siguen aquí.",
      retry: "Intentar de nuevo",
      rateLimited: "Pediste varias selecciones seguidas. Espera unos minutos e inténtalo de nuevo.",
    ...
    result: {
      ...
      modes: {
        ai: "Escrita por IA · verificada contra el catálogo",
        development: "Composición de desarrollo · sin IA configurada",
        catalogue: "Selección del catálogo · explicación con IA no disponible",
      },
      stats: {
        start: "Para empezar",
        more: "Para considerar",
        topics: "Temas",
        pool: "Productos revisados",
      },
      about: { title: "Lo que entendimos de ti" },
      start: {
        title: "Empieza aquí",
        lede: "Lo primero que te sugerimos, con la presentación que mejor encaja con tus respuestas.",
      },
      more: {
        title: "También para ti",
        lede: "Vale la pena considerarlos ahora o en tu siguiente pedido.",
      },
      supplies: { title: "Insumos", lede: "Los insumos que pediste incluir." },
      product: {
        inMind: "Lo tenías en mente",
        why: "Por qué",
        suggested: "Te sugerimos",
        presentations: "Presentaciones",
        entry: "Desde",
        documented: "Con documentación pública",
        undocumented: "Sin documentación pública todavía",
        fits: "Cabe en tu presupuesto",
        over: "Sobre tu presupuesto",
        signature: "Insignia",
      ...
      map: {
        ...
        lede: "Tus temas y los productos de tu selección. Cada línea une un producto con un tema en el que está.",
        label: "Mapa de tus temas y los productos de tu selección",
        column: "Productos",
        legend: { start: "Empieza aquí", more: "También para ti", bridges: "Cruza tus temas" },
      },
      topics: {
        title: "Tus temas",
        count: "{n} productos",
      ...
      budget: {
        ...
        open: "Sin tope: no descartamos productos por precio.",
        cap: "Tu tope",
        start: "Empieza aquí",
        all: "Toda la selección",
        fits: "Dentro de tu presupuesto",
        over: "Sobre tu presupuesto",
        unknown: "Sin precio publicado",
        method:
          "Suma de la presentación sugerida de cada producto, con precios del catálogo. Envío no incluido.",
      },
      detail: { show: "Ver el mapa y tus temas", hide: "Ocultar el mapa y tus temas" },
      next: { title: "Siguientes pasos" },
      tips: { title: "Consejos para tu compra" },
      documentation: {
        title: "Documentación",
        none: "Todavía no hay documentación pública para los productos de tu selección. Cuando exista, aparecerá vinculada a la presentación exacta que examina.",
        some: "{n} registros públicos vinculados a los productos de tu selección.",
        model: "Cómo documentamos cada producto",
      ...
      empty: {
        ...
        body: "Con este formato no hay productos en tus temas. Quita el filtro de formato o elige otros temas.",
      },
      healthNotice:
    ...
    destinations: {
      ...
      "research-index": "Índice de productos",
      "quality-model": "Cómo documentamos",
      explorer: "Explorador de documentación",
    },
    compose: {
      and: "y",
      headline: {
        "first-order": "Tu primer pedido, empezando por {topic}",
        compare: "Tus opciones en {topic}, lado a lado",
        deepen: "{topic} a fondo: por dónde empezar",
      ...
      reasons: {
        ...
        priorities: {
          documentation: "la documentación disponible",
          price: "el precio",
          signature: "tu interés en la línea insignia",
      ...
      experience: {
        ...
        experienced: "tienes mucha experiencia con productos como estos",
      },
      intent: {
        "first-order": "hacer tu primer pedido",
        compare: "comparar opciones antes de decidir",
        deepen: "conocer a fondo un tema",
        "cover-topics": "cubrir varios temas en un pedido",
        browse: "explorar el catálogo sin prisa",
      },
      budgetOpen: "sin un tope de presupuesto",
      budgetSet: "dentro de un presupuesto definido",
      horizon: {
        "one-order": "para comprar en un solo pedido",
        "over-time": "para ir comprando poco a poco",
      },
      why: {
        inMind: "Lo tenías en mente.",
        ...
        overlap: "Aparece en {topics}, así cubre más de uno de tus temas.",
        signature: "Es parte de la línea insignia de NEOGEN.",
        documented: "Tiene documentación pública.",
        undocumented: "Todavía no tiene documentación pública.",
        value: "Su precio de entrada está entre los más accesibles de tus temas.",
        fits: "Cabe en tu presupuesto.",
        over: "Queda por encima de tu presupuesto; tenlo en cuenta para después.",
        size: {
          smallest: "Te mostramos su presentación más pequeña.",
          largest: "Te mostramos su presentación más grande dentro de tu presupuesto.",
        },
        supply: "Es uno de los insumos que pediste incluir.",
      },
      topic: "{topic} tiene {count} productos en el catálogo.",
      topicPicked: "{count} están en tu selección.",
      path: {
        area: "Ve todos los productos de {label}, con sus presentaciones.",
        product: "Abre {label} para ver todas sus presentaciones y precios.",
        catalogue: "Compara con el catálogo completo y sus filtros.",
        "research-index": "Busca cualquier producto en el índice de NEOGEN Research.",
        "quality-model": "Mira cómo se vincula cada documento a la presentación que examina.",
        explorer: "Explora la documentación pública disponible.",
      },
      tips: {
        new: "Abre la ficha de cada producto antes de decidir: ahí ves todas sus presentaciones y precios.",
        compare:
          "Compara las fichas lado a lado: presentaciones, precio de entrada y documentación.",
        overTime: "Empieza con lo de «Empieza aquí» y guarda lo demás para tus siguientes pedidos.",
        soon: "Revisa la disponibilidad en cada ficha antes de pedir.",
        documentation:
          "Mira cómo documentamos cada producto para saber qué respalda cada presentación.",
        price: "Compara los precios de cada presentación en su ficha antes de elegir.",
      },
    },
  },
